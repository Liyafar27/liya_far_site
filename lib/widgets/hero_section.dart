              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'Web3 development, working with blockchains like Solana, BNB Chain, NEAR, and Bitcoin. I’ve built mobile and web apps that connect to live wallets like Phantom, MetaMask, Uniswap Wallet, and Meteor, supporting everything from token swaps and real-time price tracking to trading bots and NFT interactions.',
                      style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                            height: 1.5,
                            color: Colors.white70,
                          ),
